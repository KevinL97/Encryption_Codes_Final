...
public class Helpers {
    ...
    static void print(String[] tab, JTextArea textArea) {
        for (String tab1 : tab) {
            textArea.append(tab1 + " ");
        }
    }

    static void print(int[] tab, JTextArea textArea) {
        byte b;
        for (int i : tab) {
            b = (byte) i;
    ...
    static void clearSubKeysFile() {
        try {
            BufferedWriter writer = new BufferedWriter(new FileWriter(SUB_KEYS_FILE, false));
