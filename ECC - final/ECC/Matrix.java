...
public class Matrix {
    ...
    public void scramble(boolean type, JTextArea textArea) {
    ...
    public void log(String t, int op, int a, int b, int c, int d, JTextArea textArea) {
        textArea.append("\nsubkey : " + t + "/" + op + "/" + a + "/" + b + "/" + c + "/" + d + "\n");
